        ...
        <div className='relative z-10 w-full max-w-3xl space-y-6'>
          <div className='space-y-2 text-center'>
            ...
            <p className='text-muted-foreground'>
              {t(
                'Enter your API key to check remaining quota and usage details'
              )}
            </p>
          </div>
          ...
          {error && (
            <div className='bg-destructive/10 text-destructive border-destructive/20 flex items-center gap-3 rounded-xl border p-4'>
